...
setup(
    ...
    scripts=['appguard_ci_server/appguard_ci_server.py'],
    package_dir={'': '..'},
    packages={'appguard_ci','appguard_ci.appguard_ci_apis','appguard_ci.appguard_ci_server'},
    ...
    description='AppGuard CI MicroService Package',
    classifiers=[
