...
MAGEN_INGESTION_URLS_RESP_DICT = """{
  "response": {
    "active_urls": {
      "asset_url": "http://localhost:5020/appguard_ci/appguard_ci/v1/assets/asset/",
      "assets_url": "http://localhost:5020/appguard_ci/appguard_ci/v1/assets/",
      "single_asset_url": "http://localhost:5020/appguard_ci/appguard_ci/v1/assets/asset/{}/"
    },
    "source": "Ingestion"
  },
  "status": 200,
